...
<html>
	...
	<div class="mainheader">
		...
		<div class="menubtn">
            ...
            <center><h1 style="color:#0070fa">Tourist Details</h1></center>
        ...
        <table id="customers">
            ...
            <tbody>
                <%
                        TouristModel sm=new TouristModel();
                        TouristDao sd=new TouristDao();
                        
                        List<TouristModel> sm1=sd.getAllTourist();
                        
                        for(TouristModel plan : sm1){
                ...
                <tr>
                   ...
                   <td><a href="Tdelete.jsp?id=<%=plan.getId()%>">Delete</a></td>
                </tr>
                <%
                               }
                %>
