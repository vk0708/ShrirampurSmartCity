...
<html>
	...
	<div class="mainheader">
		...
		<div class="menubtn">
            ...
            <center><h1 style="color:#0070fa">Student Details</h1></center>
        ...
        <table id="customers">
            ...
            <tbody>
                <%
                        ...
                        List<StudentModel> sm1=sd.getAllStudent();
                        
                        for(StudentModel plan : sm1){
                ...
                <tr>
                   ...
                   <td><a href="delete.jsp?id=<%=plan.getId()%>">Delete</a></td>
                </tr>
                <%
                               }
                %>
