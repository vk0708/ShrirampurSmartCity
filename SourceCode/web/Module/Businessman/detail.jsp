...
<html>
    <head>
        ...
        <title>Businessman details</title>
	...
	<div class="mainheader">
				...
				<li class="dropdown">
					<a class="dropbtn" style="color: red">View users</a>
               			 <div class="drop">
                                    ...
                                    <a href="detail.jsp">Businessman</a>
               			 </div>
                                </li>  
		...
		<div class="menubtn">
            ...
            <center><h1 style="color:#0070fa">Businessman Details</h1></center>
        ...
        <table id="customers">
            ...
            <tbody>
                <%
                        BusinessmanModel sm=new BusinessmanModel();
                        BusinessmanDao sd=new BusinessmanDao();
                        
                        List<BusinessmanModel> sm1=sd.getAllBman();
                        
                        for(BusinessmanModel plan : sm1){
